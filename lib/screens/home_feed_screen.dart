...
class _HomeFeedScreenState extends State<HomeFeedScreen> {
  ...
  final StoryData myStory = const StoryData(
    imageUrl:
  ...
  final List<StoryData> stories = const [
    StoryData(
      imageUrl:
  ...
  final List<PostData> posts = const [
    PostData(
  ...
  Widget _buildStoriesSection(BuildContext context) {
    ...
    return Container(
      ...
      child: StoriesRow(myStory: myStory, stories: stories),
    );
  }
}
